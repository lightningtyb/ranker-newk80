...
import utils
from trainer import run_eval, msamrco_eval, set_seed
# from modeling import BertRanker, RobertaRanker
from modeling import BartDecoderRanker, BertRanker
...
def main_cli():
    ...
    MODEL = BertRanker if args.model_name == 'bert' else BartDecoderRanker
    ...
    run_eval(args, model, queries, docs, eval_run_dict, args.output_file, device, tokenizer, desc='rerank')
    if args.qrel_file:
        msamrco_eval(args.qrel_file, args.output_file)
    docs.close()
