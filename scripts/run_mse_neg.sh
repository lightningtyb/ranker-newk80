...
# MS MARCO Passage ranking dataset, query num: 325725,, valid query num (has pos doc in qrel): 367012
sleep 3h
kill 13302
python  ../decoder2/trainer.py \
  --task msmarco \
  ...
  --temp_dir /data/users/tangyubao/ranker/outputs/temp/mse_neg/ \
  ...
  --model_out_dir /data/users/tangyubao/ranker/outputs/models/mse_neg/
