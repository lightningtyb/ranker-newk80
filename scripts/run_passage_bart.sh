...
python  ../src/trainer.py \
  ...
  --temp_dir /home/tangyubao/bert-reranker-main/outputs/temp/bart_encoder/ \
  ...
  --model_out_dir /home/tangyubao/bert-reranker-main/outputs/models/bart_encoder/
