...
python  ../decoder/train.py \
  ...
  --temp_dir /home/tangyubao/bert-reranker-main/outputs/temp/bart_decoder_mse/ \
  ...
  --model_out_dir /home/tangyubao/bert-reranker-main/outputs/models/bart_decoder_mse/
